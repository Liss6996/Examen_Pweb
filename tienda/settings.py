...
SECRET_KEY = 'django-insecure-ewe$w=bi5(r)r^wi2fjnu2qs!&p8*jrynho9t@m!(0f##mzu$6'
...
INSTALLED_APPS = [
    'admin_interface', # Personalizar el panel de administración de django
    'django.contrib.auth',
